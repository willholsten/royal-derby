...
export default class Functions extends React.Component {
  ...
  render(props) {
    return (
      <div>
        <PageHeader className="functions-header" header="Accommodation" />
              ...
              <Fade up>
                <div>
                  ...
                  <p>
                    ...
                    safe and friendly accommodation with rates not seen since
                    the 80’s. We also offer 10% off food and drink to all guests
                    in our sports bar located down stairs.
                  </p>
                  <p>
                    <b>
                      Please Note: Check in and check out are completed at the
                      main bar down stairs between the hours of 2pm till 10 pm 7
                      days a week, outside these hours are available if
                      pre-arranged. We don’t cater for guests under the age of
                      18. Please call 0499 979 620 to book accommodation.
                    </b>
                  </p>
